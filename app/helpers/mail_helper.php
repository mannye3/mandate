...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f5f6fa;">
    <center style="width: 100%; background-color: #f5f6fa;">
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">Copyright © 2020 NASD. All rights reserved.</p>
        ...
        $mail->Username = 'afasina@nasdng.com';                       // SMTP username
        $mail->Password = 'ifeoluwa2016';                      // SMTP password
        $mail->SMTPSecure = "TLS"; //TLS
        $mail->Port = 587; //587                              // TCP port to connect to
        $mail->setFrom('no-reply@nasdng.com');
        $mail->addAddress($data['email']);  
        $mysql_hostname = '192.169.233.185';
        $mysql_username = 'notcsadm_otc';
        $mysql_password = 'N#M3IM^stG0';
        $mysql_dbname = 'notcsadm_nplcsadm_nsd_new';
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="text-align:center;padding: 0 30px 20px">
                                    ...
                                    <a href="' . URLROOT . '/users/reset_password/'. $data['pass_res_token'] .'" style="background-color:#6576ff;border-radius:4px;color:#ffffff;display:inline-block;font-size:13px;font-weight:600;line-height:44px;text-align:center;text-decoration:none;text-transform: uppercase; padding: 0 25px">Reset Password</a>
                                </td>
                            </tr>
                            <tr>
