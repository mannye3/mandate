                                                                ...
                                                                <li>
                                                                    ...
                                                                    <button class="btn" data-toggle="modal" data-target="#exampleModal<?php echo $allfee->id; ?>">
                                                                        <i class="icon ni ni-edit"></i>
                                                                            ...
                                                                            <form action="<?php echo URLROOT; ?>/admins/delete_fee/<?php echo $allfee->id; ?>" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-lg">
                    ...
                    <div class="tab-content">
                        <form method="post" action="<?php echo URLROOT; ?>/admins/edit_fee/<?php echo $allfee->id; ?>" >
                        <div class="tab-pane active" id="personal">
                            <div class="row gy-4">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fee_code"  class="form-control form-control-lg"  value="<?php echo $allfee->fee_code; ?>">
                                    </div>
                                </div>   
                                ...
                                <div class="modal fade" id="exampleModal<?php echo $allfee->id; ?>">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?php echo URLROOT; ?>/admins/edit_fee/<?php echo $allfee->id; ?>" method="post">
                                                <div class="form-group">
                                                    <input type="hidden" value="<?php echo $allfee->id; ?>" name="id" >
                                                    <label for="recipient-name" class="col-form-label">Name:</label>
                                                    <input  value="<?php echo $allfee->fee_title; ?>" type="text" name="fee_title" class="form-control" id="recipient-name">
                                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-lg">
                    ...
                    <div class="tab-content">
                        <form method="post" action="<?php echo URLROOT; ?>/admins/fees">
                        <div class="tab-pane active" id="personal">
                            <div class="row gy-4">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label" for="full-name">Title</label>
                                        <input type="text" name="fee_title"  class="form-control form-control-lg" id="full-name" placeholder="Enter Category Title">
                                    </div>
                                </div> 
