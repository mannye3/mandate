                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    ...
                    <form action="<?php echo URLROOT; ?>/admin_logins" method="post">
                        <div class="form-group">
                            ...
                            <input required name="admin_name" type="text" class="form-control form-control-lg " id="default-01" placeholder="Enter your email address" value="<?php echo $data['admin_name']; ?>" >
                              <p style=" color: red;"><?php echo $data['admin_name_err']; ?></p>
                        </div><!-- .foem-group -->
                        <div class="form-group">
                            <div class="form-label-group">
