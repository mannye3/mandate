                             ...
                             <div class="nk-block-head nk-block-head-sm">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h3 class="nk-block-title page-title">Reciept</h3>
                                            ...
                                            <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                <thead>
                                                    <tr class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <th class="nk-tb-col"><span class="sub-text">Firm Code</span></th>
                                                       
                                                        
                                                      
                                                        <th class="nk-tb-col tb-col-lg"><span class="sub-text">Year</span></th>


                                                        <th class="nk-tb-col tb-col-lg"><span class="sub-text">Reciept Date</span></th>

                                                       <th class="nk-tb-col tb-col-lg"><span class="sub-text">Reciept Date</span></th>


                                                      
                                                         <th class="nk-tb-col tb-col-lg"><span class="sub-text">
                                                            Created At
                                                       </span></th>
                                                ...
                                                <tbody>
                                                     <?php  $count = 0; foreach($data['allReceipts'] as $allReceipt) :  $count++; ?>
                                                    <tr class="nk-tb-item">
                                                        ...
                                                        <td class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-info">
                                                                    <span class="tb-lead"><?php echo $allReceipt->mandate_code; ?> <span class="dot dot-success d-md-none ml-1"></span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="nk-tb-col tb-col-lg">
                                                            <span><?php echo $allReceipt->select_year; ?></span>
                                                        </td>


                                                        <td class="nk-tb-col tb-col-lg">
                                                            <span><?php echo $allReceipt->receipt_date; ?></span>
                                                        </td>


                                                        <td class="nk-tb-col tb-col-md">
                                                            <?php echo $allReceipt->receipt_number
                                                        ...
                                                        <td class="nk-tb-col tb-col-md">
                                                            <?php echo $allReceipt->created_at
                                                        ...
                                                        <td class="nk-tb-col tb-col-md">
                                                                <form method="post" action="<?php echo URLROOT; ?>/accounts/receiptsprocess">
                                                                <input type="hidden" value="<?php echo $allReceipt->receipt_number ?>" name="receipt_number">
                                                                <input type="hidden" value="<?php echo $allReceipt->mandate_code; ?>" name="mandate_code">
                                                                <button type="submit" class="badge badge-sm badge-success">Print</button>
                                                                </form>
