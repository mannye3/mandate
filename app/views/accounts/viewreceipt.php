...
<div class="container-fluid invoice-container">
  ...
  <div class="row">
    ...
    <div class="col-sm-6 text-sm-right"> 
      <strong>Receipt  No:</strong>  <?php echo $data['receipt_details']->receipt_number; ?>
      <br>
      <strong>Date:</strong> <?php echo $data['receipt_details']->receipt_date; ?>
                         ...
                         <table class="table table-condensed">
                            ...
                            <tbody>
                              ...
                              $mandate_code =  $_SESSION['mandate_code'];
                                ...
                                ?>
                                 ...
                                 $count = 0;  foreach($allReceipts as $allReceipt) : $count++; ?>
                                <tr>
                                    <td> <?php echo $count;  ?></td>
                                    <td><?php echo $allReceipt->fee_title; ?></td>
                                    <td class="text-center"><?php echo $allReceipt->select_year; ?></td>
                                    <td class="text-center">

                                       <?php  if($allReceipt->discount_amount !== "" ) : ?>
                                        ₦<?php echo number_format($allReceipt->discount_amount); ?>
                                        <?php  if($allReceipt->discount == 2 ) : ?>
                                                                          (10%)
                                                                     <?php endif ?>

                                                                       <?php  if($allReceipt->discount == 1 ) : ?>
                                                                          (5%)
                                                                     <?php endif ?>
                                          <?php endif ?>
                                          ...
                                          <?php  if($allReceipt->discount_amount == "" ) : ?>
                                        ₦<?php echo number_format($allReceipt->amount); ?>
                                          <?php endif ?>
                                 ...
                                 <?php endforeach; ?>
                                 <?php $select_year =  $allReceipt->select_year; ?>
                               
                              <?php   $mandate_accounts_Total = $this->accountModel->getAccountRecByYear($mandate_code,$select_year);

                               $mandate_accounts_Total_Dis = $this->accountModel->getAccountRecByYearDiscount($mandate_code,$select_year);
                            ...
                            <!--     <tr>
                                ...
                                <tr>
                                   ...
                                   $TD =  $mandate_accounts_Total->TotalAmountPaidYear;
                                   $TS =  $mandate_accounts_Total_Dis->TotalAmountPaidYeardiscount;

                                   $TDTS = $TD + $TS;

                                    echo number_format($TDTS); ?></td>
                                </tr>
