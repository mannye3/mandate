                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                             ...
                                             <tbody>
                                                   <?php  $count = 0; foreach($data['daily_price_list'] as $daily_price_list) :  $count++; ?>
                                                    <tr>
                                                        <td><?php echo $count; ?></td>
                                                       
                                                        <td>
                                         <?php echo $daily_price_list->price_date;?>
                                                          
                                                        </td>
                                                        <td> <?php echo $daily_price_list->security_name; ?></td>

                                                        <td> <?php echo $daily_price_list->security; ?></td>
                                                        <td><?php echo $daily_price_list->ref_price; ?></td>
                                                          <td><?php echo $daily_price_list->close_price; ?></td>
