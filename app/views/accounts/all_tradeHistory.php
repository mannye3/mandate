                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">All Trades</h4>
                        ...
                        <div class="row">
                            ...
                            <br>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                             ...
                                             <tbody>
                                                   <?php  $count = 0; foreach($data['get_gen_report'] as $get_gen_report) :  $count++; ?>
                                                    <tr>
                                            ...
                                            <td><?php echo $get_gen_report->BUYER_NAME; ?> </td>
                                            <td><?php echo $get_gen_report->FROM_MEMBER; ?></td>
                                            <td><?php echo $get_gen_report->SELLER_NAME; ?></td>  
                                            <td><?php echo $get_gen_report->TO_MEMBER; ?></td>
                                            <td><?php echo $get_gen_report->VOLUME; ?></td>
                                            <td><?php echo $get_gen_report->PRICE / 10000; ?></td>
                                            <td> <?php echo date('jS \ F Y ', strtotime($get_gen_report->TRADE_DATE));?></td>
