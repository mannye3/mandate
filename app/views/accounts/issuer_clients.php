                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <!-- <div class="button-items">
                                          <button data-toggle="modal" data-target="#exampleModal5" data-whatever="@mdo" type="button" class="btn btn-outline-primary waves-effect waves-light">Add New Client</button> 
                                                   ...
                                                   <?php  $count = 0; foreach($data['All_Clients'] as $All_Clients) :  $count++; ?>
                                                    <tr>
                                                       ...
                                                       <!--  <td>
                                                        ...
                                                        <td>
                                                          <a href="<?php echo URLROOT; ?>/accounts/edit_client/<?php echo $All_Clients->id; ?>">  <button type="button" class="btn btn-outline-success btn-sm"> <i class="fa fa-edit"></i> Edit</button></a> 
                                                             <br>

                                                             <form action="<?php echo URLROOT; ?>/accounts/delete_client/<?php echo $All_Clients->id; ?>" method="POST">
