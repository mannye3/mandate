                                                                ...
                                                                <li>
                                                                    ...
                                                                    <button class="btn" data-toggle="modal" data-target="#exampleModal<?php echo $allcate->id; ?>">
                                                                        ...
                                                                        <?php if ($_SESSION['role'] == 'Admin') : ?>
                                                                            ...
                                                                            <form action="<?php echo URLROOT; ?>/accounts/delete_category/<?php echo $allcate->id; ?>" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-lg">
                    ...
                    <div class="tab-content">
                        <form method="post" action="<?php echo URLROOT; ?>/accounts/edit_category/<?php echo $allcate->id; ?>">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-lg">
                    ...
                    <div class="tab-content">
                        <form method="post" action="<?php echo URLROOT; ?>/accounts/categories">
                        <div class="tab-pane active" id="personal">
                            <div class="row gy-4">
                                <div class="col-md-12">
                                    <div class="form-group">
