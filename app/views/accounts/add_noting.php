            ...
            <div class="add-edit-product-wrap col-12">
                ...
                <div class="add-edit-product-form">
                    <form action="<?php echo URLROOT; ?>/accounts/upload_noting" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12 mb-30"><input class="form-control" type="text" name="company" placeholder="Company Name"></div>
                            ...
                            <div class="col-lg-6 col-12 mb-30"><input class="form-control" type="text" name="buyer" placeholder="Buyer Name"></div>
                            <div class="col-lg-6 col-12 mb-30"><input class="form-control" type="text" name="seller" placeholder="Seller Name"></div>
                        ...
                        <div class="product-upload-gallery row flex-wrap">
                            <div class="col-6 mb-30">
                             ...
                             <div class="col-6 mb-30">
                                  <h4 class="title">Document to Registr</h4>
                                <p class="form-help-text mt-0">Upload Maximum 800 x 800 px & Max size 2mb.</p>
